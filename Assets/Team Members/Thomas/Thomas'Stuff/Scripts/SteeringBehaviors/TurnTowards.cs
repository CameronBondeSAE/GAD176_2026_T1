...
public class TurnTowards : MonoBehaviour
{
    ...
    private List<ThomasNode> originalPath = new List<ThomasNode>(); //for debug visualization
    ...
    public void SetPath(List<ThomasNode> path)
    {
        ...
        originalPath = new List<ThomasNode>(path);
    ...
    private List<Vector3> ExtractTurningPoints(List<ThomasNode> path)
    {
