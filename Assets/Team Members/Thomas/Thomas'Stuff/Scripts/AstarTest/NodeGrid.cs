...
public class NodeGrid : MonoBehaviour
{
    ...
    public List<ThomasNode> openList = new List<ThomasNode>();
    public List<ThomasNode> closedList = new List<ThomasNode>();
    ...
    {
        grid = new ThomasNode[gridSizeX, gridSizeY];
    ...
    public ThomasNode GetNode(int x, int y)
    {
    ...
    private void OnDrawGizmos()
    {
        ...
        {
            foreach (ThomasNode node in grid)
            {
...
public class ThomasNode
{
    ...
    public int gCost;
    public int hCost;
    public ThomasNode parent;

    public ThomasNode(bool _walkable, Vector3 _worldPos, int _gridX, int _gridY)
    {
        walkable = _walkable;
